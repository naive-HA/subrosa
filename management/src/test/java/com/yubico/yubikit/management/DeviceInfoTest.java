...
public class DeviceInfoTest {
  ...
  public void testParseVersion() {
    assertEquals(new Version(5, 3, 4), infoOf(0x05, Hex.decode("050304")).getVersion());
  }
  ...
  public void testParseFormFactor() {
    ...
    assertEquals(FormFactor.USB_A_KEYCHAIN, infoOf(0x04, Hex.decode("01")).getFormFactor());
    assertEquals(FormFactor.USB_A_NANO, infoOf(0x04, Hex.decode("02")).getFormFactor());
    assertEquals(FormFactor.USB_C_KEYCHAIN, infoOf(0x04, Hex.decode("03")).getFormFactor());
    assertEquals(FormFactor.USB_C_NANO, infoOf(0x04, Hex.decode("04")).getFormFactor());
    assertEquals(FormFactor.USB_C_LIGHTNING, infoOf(0x04, Hex.decode("05")).getFormFactor());
    assertEquals(FormFactor.USB_A_BIO, infoOf(0x04, Hex.decode("06")).getFormFactor());
    assertEquals(FormFactor.USB_C_BIO, infoOf(0x04, Hex.decode("07")).getFormFactor());
    // the form factor byte contains fips (0x80) and sky (0x40) flags
    assertEquals(FormFactor.USB_A_BIO, infoOf(0x04, Hex.decode("46")).getFormFactor());
    assertEquals(FormFactor.USB_C_NANO, infoOf(0x04, Hex.decode("84")).getFormFactor());
  }

  @Test
  public void testParseLocked() {
    assertFalse(defaultInfo().isLocked());
    assertTrue(infoOf(0x0a, Hex.decode("01")).isLocked());
    assertFalse(infoOf(0x0a, Hex.decode("00")).isLocked());
  }

  @Test
  public void testParseFips() {
    assertFalse(defaultInfo().isFips());
    assertTrue(infoOf(0x04, Hex.decode("80")).isFips());
    assertTrue(infoOf(0x04, Hex.decode("C0")).isFips());
    assertFalse(infoOf(0x04, Hex.decode("40")).isFips());
  }

  @Test
  public void testParseSky() {
    assertFalse(defaultInfo().isSky());
    assertTrue(infoOf(0x04, Hex.decode("40")).isSky());
    assertTrue(infoOf(0x04, Hex.decode("C0")).isSky());
    assertFalse(infoOf(0x04, Hex.decode("80")).isSky());
  }
  ...
  public void testParsePartNumber() {
    ...
    assertEquals(
        ...
        infoOf(
            ...
            .getPartNumber());
    assertEquals("😀", infoOf(0x13, Hex.decode("F09F9880")).getPartNumber());
    assertEquals(
        "0123456789ABCDEF",
        infoOf(0x13, Hex.decode("30313233343536373839414243444546")).getPartNumber());

    // invalid UTF-8
    assertNull(infoOf(0x13, Hex.decode("c328")).getPartNumber());
    assertNull(infoOf(0x13, Hex.decode("a0a1")).getPartNumber());
    assertNull(infoOf(0x13, Hex.decode("e228a1")).getPartNumber());
    assertNull(infoOf(0x13, Hex.decode("e28228")).getPartNumber());
    assertNull(infoOf(0x13, Hex.decode("f0288cbc")).getPartNumber());
    assertNull(infoOf(0x13, Hex.decode("f09028bc")).getPartNumber());
    assertNull(infoOf(0x13, Hex.decode("f0288c28")).getPartNumber());
  }

  @Test
  public void testParseFipsCapable() {
    assertEquals(0, defaultInfo().getFipsCapable());
    assertEquals(FIDO2.bit, infoOf(0x14, Hex.decode("0001")).getFipsCapable());
    assertEquals(PIV.bit, infoOf(0x14, Hex.decode("0002")).getFipsCapable());
    assertEquals(OPENPGP.bit, infoOf(0x14, Hex.decode("0004")).getFipsCapable());
    assertEquals(OATH.bit, infoOf(0x14, Hex.decode("0008")).getFipsCapable());
    assertEquals(HSMAUTH.bit, infoOf(0x14, Hex.decode("0010")).getFipsCapable());
    assertEquals(PIV.bit | OATH.bit, infoOf(0x14, Hex.decode("000A")).getFipsCapable());
  }

  @Test
  public void testParseFipsApproved() {
    assertEquals(0, defaultInfo().getFipsApproved());
    assertEquals(FIDO2.bit, infoOf(0x15, Hex.decode("0001")).getFipsApproved());
    assertEquals(PIV.bit, infoOf(0x15, Hex.decode("0002")).getFipsApproved());
    assertEquals(OPENPGP.bit, infoOf(0x15, Hex.decode("0004")).getFipsApproved());
    assertEquals(OATH.bit, infoOf(0x15, Hex.decode("0008")).getFipsApproved());
    assertEquals(HSMAUTH.bit, infoOf(0x15, Hex.decode("0010")).getFipsApproved());
    assertEquals(PIV.bit | OATH.bit, infoOf(0x15, Hex.decode("000A")).getFipsApproved());
  }

  @Test
  public void testParsePinComplexity() {
    assertFalse(defaultInfo().getPinComplexity());
    assertFalse(infoOf(0x16, Hex.decode("00")).getPinComplexity());
    assertTrue(infoOf(0x16, Hex.decode("01")).getPinComplexity());
  }

  @Test
  public void testParseResetBlocked() {
    assertEquals(0, defaultInfo().getResetBlocked());
    assertEquals(1056, infoOf(0x18, Hex.decode("0420")).getResetBlocked());
  }

  @Test
  public void testParseFpsVersion() {
    assertNull(defaultInfo().getFpsVersion());
    assertNull(infoOf(0x20, Hex.decode("000000")).getFpsVersion());
    assertNull(infoOf(0x20, Hex.decode("000000000000000000")).getFpsVersion());
    assertEquals(new Version(0, 0, 1), infoOf(0x20, Hex.decode("000001")).getFpsVersion());
    assertEquals(new Version(5, 6, 6), infoOf(0x20, Hex.decode("050606")).getFpsVersion());
  }

  @Test
  public void testParseStmVersion() {
    assertNull(defaultInfo().getStmVersion());
    assertNull(infoOf(0x21, Hex.decode("000000")).getStmVersion());
    assertNull(infoOf(0x21, Hex.decode("000000000000000000")).getStmVersion());
    assertEquals(new Version(0, 0, 1), infoOf(0x21, Hex.decode("000001")).getStmVersion());
    assertEquals(new Version(7, 0, 5), infoOf(0x21, Hex.decode("070005")).getStmVersion());
  }
  ...
  public void testParseVersionQualifier() {
    ...
    info = infoOfVersion(Hex.decode("030403"), null);
    ...
    info = infoOfVersion(Hex.decode("000001"), Hex.decode("0103050403020100030400000000"));
    ...
    info = infoOfVersion(Hex.decode("000001"), Hex.decode("01030507080201010304000000e9"));
    ...
    info = infoOfVersion(Hex.decode("050404"), Hex.decode("0103050404020102030400000005"));
    ...
    info = infoOfVersion(Hex.decode("050709"), Hex.decode("01030507090201020304FFFFFFFF"));
    ...
    info = infoOfVersion(Hex.decode("05070A"), Hex.decode("010305070A020102030480000000"));
    ...
    info = infoOfVersion(Hex.decode("05070B"), Hex.decode("010305070B02010203047FFFFFFF"));
